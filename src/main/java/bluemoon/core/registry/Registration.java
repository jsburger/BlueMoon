...
import static bluemoon.core.registry.utility.RegistrationUtil.registerBlock;
...
public class Registration {
    ...
    public static final RegistryObject<Block> BORDERED_MOONSTONE_FLAGSTONE = registerBlock("bordered_moonstone_flagstone", () -> new Block(SharedProperties.MOONSTONE));
     ...
     //Bristlepine
    public static final RegistryObject<Block>        BRISTLEPINE_SAPLING = registerBlock("bristlepine_sapling",        () -> new SaplingBlock(new AcaciaTree(), Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().hardnessAndResistance(0.0F).sound(SoundType.PLANT)));
    ...
    public static final RegistryObject<Block>           BRISTLEPINE_DOOR = registerBlock("bristlepine_door",           () -> new DoorBlock(SharedProperties.BRISTLEPINE().notSolid()));
    public static final RegistryObject<Block>       BRISTLEPINE_TRAPDOOR = registerBlock("bristlepine_trapdoor",       () -> new TrapDoorBlock(SharedProperties.BRISTLEPINE().notSolid()));
    public static final RegistryObject<Block>         BRISTLEPINE_BUTTON = registerBlock("bristlepine_button",         () -> new WoodButtonBlock(Block.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)));

...
import bluemoon.blocks.ablanite.AblaniteBlock;
import bluemoon.blocks.ablanite.AblaniteSlabBlock;
import bluemoon.blocks.ablanite.AlbaniteWallBlock;
import bluemoon.features.trees.BristlepineTree;
import bluemoon.registry.utility.ComplexStoneBlockSet;
...
public class AllBlocks {
    ...
    public static final StoneBlockSet POLISHED_NEBULITE = new StoneBlockSet(createBlock("polished_nebulite", () -> new Block(SharedProperties.NEBULITE)), false).addSlabs().addStairs();
     //Ablanite
    public static final StoneBlockSet ABLANITE          = new ComplexStoneBlockSet(createBlock("ablanite",          () -> new AblaniteBlock(SharedProperties.ABLANITE)), AblaniteSlabBlock::new, AlbaniteWallBlock::new, null).addStairs();
    public static final StoneBlockSet POLISHED_ABLANITE = new ComplexStoneBlockSet(createBlock("polished_ablanite", () -> new AblaniteBlock(SharedProperties.ABLANITE)), AblaniteSlabBlock::new, AlbaniteWallBlock::new, null).addStairs();
    ...
    public static final RegistryObject<Block>            LIGHTSIDE_LOG = createBlock("lightside_log",            () -> new RotatedPillarBlock(SharedProperties.LIGHTSIDE_OAK));
    public static final RegistryObject<Block>   STRIPPED_LIGHTSIDE_LOG = createBlock("stripped_lightside_log",   () -> new RotatedPillarBlock(SharedProperties.LIGHTSIDE_OAK));
    public static final RegistryObject<Block>           LIGHTSIDE_WOOD = createBlock("lightside_wood",           () -> new RotatedPillarBlock(SharedProperties.LIGHTSIDE_OAK));
    public static final RegistryObject<Block>  STRIPPED_LIGHTSIDE_WOOD = createBlock("stripped_lightside_wood",  () -> new RotatedPillarBlock(SharedProperties.LIGHTSIDE_OAK));
    ...
    public static final RegistryObject<Block>            DARKSIDE_LOG = createBlock("darkside_log",            () -> new RotatedPillarBlock(SharedProperties.DARKSIDE_OAK));
    public static final RegistryObject<Block>   STRIPPED_DARKSIDE_LOG = createBlock("stripped_darkside_log",   () -> new RotatedPillarBlock(SharedProperties.DARKSIDE_OAK));
    public static final RegistryObject<Block>           DARKSIDE_WOOD = createBlock("darkside_wood",           () -> new RotatedPillarBlock(SharedProperties.DARKSIDE_OAK));
    public static final RegistryObject<Block>  STRIPPED_DARKSIDE_WOOD = createBlock("stripped_darkside_wood",  () -> new RotatedPillarBlock(SharedProperties.DARKSIDE_OAK));
